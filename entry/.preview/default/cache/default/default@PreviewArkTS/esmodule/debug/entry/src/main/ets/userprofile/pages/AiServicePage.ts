...
class AiServicePage extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Flex.debugLine("entry/src/main/ets/userprofile/pages/AiServicePage.ets(74:5)", "entry");
            // 使用 Flex 容器，direction 设为 Column
            // Flex 在处理键盘挤压时表现更稳定
            Flex.width('100%');
            // 使用 Flex 容器，direction 设为 Column
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            // ===============================================
            Column.create();
            Column.debugLine("entry/src/main/ets/userprofile/pages/AiServicePage.ets(79:7)", "entry");
            // ===============================================
            // 1. 顶部 Header 区域 (绝对固定，不受键盘影响)
            // ===============================================
            Column.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Row.create();
            Row.debugLine("entry/src/main/ets/userprofile/pages/AiServicePage.ets(82:9)", "entry");
            // 1.1 状态栏占位层 (高度动态适配)
            // 它的存在就是为了把标题栏“顶”下来，不遮挡电池信号
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Column.create();
            Column.debugLine("entry/src/main/ets/userprofile/pages/AiServicePage.ets(96:7)", "entry");
            // ===============================================
            // 2. 中间消息列表 (弹性伸缩)
            // ===============================================
            // flexGrow(1) 确保它占据剩余的所有空间
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            List.debugLine("entry/src/main/ets/userprofile/pages/AiServicePage.ets(97:9)", "entry");
            List.width('100%');
            List.height('100%');
        ...
        }, List);
        {
            ...
            const itemCreation2 = (elmtId, isInitialRender) => {
                ...
                // 顶部的一点留白
                ListItem.height(10);
                ListItem.debugLine("entry/src/main/ets/userprofile/pages/AiServicePage.ets(99:11)", "entry");
            };
        ...
        }
        {
            ...
            const itemCreation2 = (elmtId, isInitialRender) => {
                ListItem.create(deepRenderFunction, true);
                ListItem.debugLine("entry/src/main/ets/userprofile/pages/AiServicePage.ets(102:11)", "entry");
            };
            const deepRenderFunction = (elmtId, isInitialRender) => {
                itemCreation(elmtId, isInitialRender);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Row.create();
                    Row.debugLine("entry/src/main/ets/userprofile/pages/AiServicePage.ets(103:13)", "entry");
                    Row.width('100%');
                    Row.justifyContent(FlexAlign.Center);
                }, Row);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create('🛡️ 官方认证 · 信息加密传输中');
                    Text.debugLine("entry/src/main/ets/userprofile/pages/AiServicePage.ets(104:15)", "entry");
                    Text.fontSize(12);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            const forEachItemGenFunction = _item => {
                const item = _item;
                {
                    ...
                    const itemCreation2 = (elmtId, isInitialRender) => {
                        ListItem.create(deepRenderFunction, true);
                        ListItem.debugLine("entry/src/main/ets/userprofile/pages/AiServicePage.ets(111:13)", "entry");
                    };
                    const deepRenderFunction = (elmtId, isInitialRender) => {
                        itemCreation(elmtId, isInitialRender);
        ...
        ForEach.pop();
        {
            ...
            const itemCreation2 = (elmtId, isInitialRender) => {
                ...
                // 底部留白，防止最后一条消息紧贴输入框
                ListItem.height(10);
                ListItem.debugLine("entry/src/main/ets/userprofile/pages/AiServicePage.ets(117:11)", "entry");
            };
            const deepRenderFunction = (elmtId, isInitialRender) => {
                itemCreation(elmtId, isInitialRender);
                // 底部留白，防止最后一条消息紧贴输入框
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            // ===============================================
            Column.create();
            Column.debugLine("entry/src/main/ets/userprofile/pages/AiServicePage.ets(130:7)", "entry");
    ...
    buildHeaderContent(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/userprofile/pages/AiServicePage.ets(155:5)", "entry");
            Row.width('100%');
            Row.height(50);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 返回按钮
            Row.create();
            Row.debugLine("entry/src/main/ets/userprofile/pages/AiServicePage.ets(157:7)", "entry");
            // 返回按钮
            Row.width(36);
            // 返回按钮
            Row.height(36);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('<');
            Text.debugLine("entry/src/main/ets/userprofile/pages/AiServicePage.ets(158:9)", "entry");
            Text.fontSize(22);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 标题
            Column.create();
            Column.debugLine("entry/src/main/ets/userprofile/pages/AiServicePage.ets(174:7)", "entry");
            // 标题
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('智能客服');
            Text.debugLine("entry/src/main/ets/userprofile/pages/AiServicePage.ets(175:9)", "entry");
            Text.fontSize(18);
            Text.fontWeight(FontWeight.Bold);
            Text.fontColor(Color.White);
        }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/userprofile/pages/AiServicePage.ets(179:9)", "entry");
            Row.margin({ top: 2 });
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Circle.create({ width: 6, height: 6 });
            Circle.debugLine("entry/src/main/ets/userprofile/pages/AiServicePage.ets(180:11)", "entry");
            Circle.fill('#44FF99');
            Circle.margin({ right: 4 });
        }, Circle);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('在线中');
            Text.debugLine("entry/src/main/ets/userprofile/pages/AiServicePage.ets(181:11)", "entry");
            Text.fontSize(11);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 菜单
            Text.create('···');
            Text.debugLine("entry/src/main/ets/userprofile/pages/AiServicePage.ets(192:7)", "entry");
            // 菜单
            Text.fontSize(24);
            // 菜单
            Text.fontColor(Color.White);
    ...
    buildMessageItem(item: ChatMessage, parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/userprofile/pages/AiServicePage.ets(205:5)", "entry");
            Row.width('100%');
            ...
            if (!item.isSelf) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        // AI 头像
                        Text.create('AI');
                        Text.debugLine("entry/src/main/ets/userprofile/pages/AiServicePage.ets(208:9)", "entry");
                        // AI 头像
                        Text.fontSize(13);
                        // AI 头像
                        Text.fontWeight(FontWeight.Bold);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/userprofile/pages/AiServicePage.ets(222:7)", "entry");
            // 消息气泡
            Text.fontSize(15);
            // 消息气泡
            ...
            if (item.isSelf) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        // 用户头像
                        Text.create('我');
                        Text.debugLine("entry/src/main/ets/userprofile/pages/AiServicePage.ets(239:9)", "entry");
                        // 用户头像
                        Text.fontSize(13);
                        // 用户头像
                        Text.fontWeight(FontWeight.Bold);
    ...
    buildInputArea(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/userprofile/pages/AiServicePage.ets(260:5)", "entry");
            Row.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            TextInput.debugLine("entry/src/main/ets/userprofile/pages/AiServicePage.ets(261:7)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/userprofile/pages/AiServicePage.ets(278:7)", "entry");
            Button.height(36);
            Button.width(64);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('发送');
            Text.debugLine("entry/src/main/ets/userprofile/pages/AiServicePage.ets(279:9)", "entry");
            Text.fontSize(14);
